...
- [bazel-to-msbuild](https://github.com/sammi/bazel-to-msbuild) - Generator Visusal Studio solution and projects from bazel workspace, command line tool build by Java.
